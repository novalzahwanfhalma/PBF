...
export default function Accordion() {
    ...
    return (
        ...
        >
            Nama "Almaty" berasal dari kata <span lang="KK-KZ">anma</span>, dalam bahasa kazakh yang berarti "apel" dan sering diterjemakna sebagai "penuh dengan apel". sebenarnya, wilayah sekitaran almaty dipercaya sebagai asal usul apel, dan <i lang="la">Malus sieversii</i> liar dianggap sebagai kandidat yang mungkin menjadi nenek moyang apel domestik modern. 
        </Panel>
        </>
    );
}
